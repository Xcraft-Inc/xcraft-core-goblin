  ...
  doQuest (questName, msg, resp) {
    return watt (function* (quest, next) {
      ...
      try {
        ...
        if (questName === 'delete') {
          console.log ('TRY DELETING: ', this._goblinId);
          ...
          if (GOBLINS_REFS[this._goblinId] === 0) {
            for (const g in GOBLINS_USES[this.goblinName][this._goblinId]) {
              ...
              if (GOBLINS_REFS[use.id]) {
                GOBLINS_REFS[use.id]--;
                if (GOBLINS_REFS[use.id] === 0) {
                  GOBLINS_REFS[use.id] = 1;
                  ...
                  console.log ('REMAIN: ', GOBLINS_REFS[use.id], ' ', use.id);
                }
              }
            }
            ...
            console.log (this._goblinId, 'DELETED!');
          } else {
            console.log (
              'REMAIN: ',
              GOBLINS_REFS[this._goblinId],
