...
class Elf {
  ...
  static configure(elfClass, logicClass) {
    ...
    /* Register Ripley stuff */
    if (elfClass.ripley) {
      goblinConfig.ripley = elfClass.ripley;
      ...
      if (goblinConfig.ripley.persist) {
    ...
    if (logicClass) {
      ...
      if (goblinConfig?.ripley?.persist && logicClass.prototype.persist) {
        xLog.warn(
