    ...
    if (logicClass) {
      ...
      if (logic instanceof Elf.Archetype) {
        ...
        Goblin.registerQuest(goblinName, '$4ellen', async (quest, actions) => {
           ...
           * and one 'persist' actions. If it's true, then we replay the received 'create'
           * action. In all other cases, the received 'create' actions must be ignored.
           */
          ...
          cryoManager.syncBroadcast(quest, quest.goblin.ripley.persist.db);
