...
class CryoReader extends SQLite {
  ...
  *getGoblinIds(goblinType, options) {
   ...
   *
   * The query argument must be the value returned by the pickaxe
   * FinalyQuery::json() method. The third argument of queryArchetype must
   * be true in order to prevent useless attach/detach since it will be
