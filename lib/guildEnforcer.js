...
let usersCacheDir;
module.exports = (busConfig, {enableGuildEnforcerCache}) => {
  ...
  if (enableGuildEnforcerCache && !usersCacheDir) {
  ...
  const usersDB = enableGuildEnforcerCache
    ? new ShieldUsers(usersCacheDir)
    : null;
